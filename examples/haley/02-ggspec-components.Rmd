...
`data_spc()` will return a named list of datasets, named `data-00`, `data-01`, ... 
...
I think that scales will be one-to-one: Operates on a single scale, used with purrr::map() to get `scales_spc`
