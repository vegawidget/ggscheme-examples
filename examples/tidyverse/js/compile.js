(function (global, factory) {
    ...
    function gg2xclass(layer, ggJSON) {
        ...
        for (var _i = 0, _a = ggJSON['scales']; _i < _a.length; _i++) {
            var ggScale = _a[_i];
            if (ggScale['aesthetics'] == 'x') {
                scale = ggScale['transform'];
            }
        }
        var xClass = {
            field: field,
            type: layer['mapping']['x']['type'],
            title: ggJSON['labels']['x'],
            scale: scale
        };
        return xClass;
    }
    function gg2yclass(layer, ggJSON) {
        ...
        for (var _i = 0, _a = ggJSON['scales']; _i < _a.length; _i++) {
            var ggScale = _a[_i];
            if (ggScale['aesthetics'] == 'y') {
                scale = ggScale['transform'];
            }
        }
        var yClass = {
            field: field,
            type: layer['mapping']['y']['type'],
            title: ggJSON['labels']['y'],
            scale: scale
        };
        return yClass;
    }
    function gg2color(layer, ggJSON) {
        ...
        if (layer['mapping']['colour']) {
            ...
            color = {
                field: field,
                type: layer['mapping']['colour']['type'],
